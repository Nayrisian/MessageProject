...
public class Encrypt {
    ...
    private static CipherTextIvMac encrypt(byte[] plaintext, SecretKeys secretKeys)
        ...
        /*
         * Now we getName back the IV that will actually be used. Some Android
     ...
     * Will only run once, and every subsequent run should return immediately.
     */
    ...
    public static class SecretKeys {
         ...
         */
        private SecretKeys(SecretKey confidentialityKeyIn, SecretKey integrityKeyIn) {
            setConfidentialityKey(confidentialityKeyIn);
            setIntegrityKey(integrityKeyIn);
        }

        private SecretKey getConfidentialityKey() {
            return confidentialityKey;
        }

        private void setConfidentialityKey(SecretKey confidentialityKey) {
        ...
        private void setIntegrityKey(SecretKey integrityKey) {
        ...
        public boolean equals(Object obj) {
            ...
            return integrityKey.equals(other.integrityKey) &&
                    confidentialityKey.equals(other.confidentialityKey);
        }
    }
    ...
    public static class CipherTextIvMac {
         ...
         * @param h The mac
         */
        private CipherTextIvMac(byte[] c, byte[] i, byte[] h) {
    ...
    private static final class PrngFixes {
        ...
        private static class LinuxPRNGSecureRandom extends SecureRandomSpi {
             ...
             * serialized (on sLock) to ensure that multiple threads do not getName
